...
class InstallationSurvey extends StatefulWidget {
  @override
  _InstallationSurveyState createState() => _InstallationSurveyState();
}

class _InstallationSurveyState extends State<InstallationSurvey> {
  @override
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        'Did the Technician reach your location in time?',
                        style: TextStyle(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Did the Technician take care of your car accessories during the insallation ?',
                          style: TextStyle(
                              fontFamily: 'PoppinsRegular',
                              color: Colors.black,
                              fontSize: 14),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'How was your over all experience with IGI Drive Tracker Installation ?',
                          style: TextStyle(
                              fontFamily: 'PoppinsRegular',
                              color: Colors.black,
                              fontSize: 14),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Was the Technician courteous white communicating?',
                          style: TextStyle(
                              fontFamily: 'PoppinsRegular',
                              color: Colors.black,
                              fontSize: 14),
