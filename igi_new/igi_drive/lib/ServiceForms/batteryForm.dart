  ...
  Widget build(BuildContext context) {
    _trySubmit() async {
      ...
      if (isValid) {
        ...
        var url =
            'http://api.igiinsurance.com.pk:8888/drive_api/battery_temper.php?vehicle=${vechilename}&reason=${route.text}&from_date=${fromDate.text}&to_date=${toDate.text}';
        print(url);
        http.Response res = await http.get(
          Uri.parse(url),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      child: Text('Reason For Battery Tamper *',
                          style: TextStyle(
                            fontFamily: 'PoppinsMedium',
