  ...
  void initState() {
    ...
    if (response.statusCode == 200) {
      ...
      if (respondedData['succeed']) {
        setState(() {
            StockList = respondedData['data'];
                  Navigator.pop(context);

                  double sum = 0;
                  for (var i = 0; i < StockList.length; i++) {
                    print(StockList[i]['balance']);
                    sum += StockList[i]['balance'];
                  }
                  print(sum);
                    ...
                    children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text(StockList.length.toString(),
                                  style: new TextStyle(
                                      fontSize: 18,
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if(StockList[index]['expiryDate'] != null){
                    //  formattedDate = DateFormat('dd MMM, yyyy').format(
                    //   DateTime.parse(
                    //       StockList[index]['expiryDate'].toString()));
                    formattedDate = StockList[index]['expiryDate'];
                  }
                  else{
                     formattedDate = "";
                  }
                  ...
                  return StockList[index]['itemName']
                              .toString()
                              .toLowerCase()
                                          ...
                                          RichText(
                                            text: new TextSpan(
                                              ...
                                              children: <TextSpan>[
                                                ...
                                                new TextSpan(
                                                    text:
                                                        '${StockList[index]['balance'].toString()}',
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily:
                                                            'PoppinsRegular',
                                          ...
                                          RichText(
                                            text: new TextSpan(
                                              ...
                                              children: <TextSpan>[
                                                ...
                                                new TextSpan(
                                                    text:
                                                        '${StockList[index]['itemIN'].toString()}',
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily:
                                                            'PoppinsRegular',
                                          ...
                                          RichText(
                                            text: new TextSpan(
                                              ...
                                              children: <TextSpan>[
                                                ...
                                                new TextSpan(
                                                    text:
                                                        '${StockList[index]['itemOut'].toString()}',
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily:
                                                            'PoppinsRegular',
                                          ...
                                          RichText(
                                            text: new TextSpan(
                                              ...
                                              children: <TextSpan>[
                                                ...
                                                new TextSpan(
                                                    text:
                                                        '${StockList[index]['itemName'].toString()}',
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily:
                                                            'PoppinsRegular',
